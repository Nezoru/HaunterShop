    ...
    <div className="flex w-full flex-col md:col-span-4">
      ...
      <div className="flex grow flex-col justify-between rounded-xl bg-gray-50 p-4">
              ...
              >
                <div className="flex items-center">
                  ...
                  <div className="min-w-0">
                    ...
                    <p className={`${shadowsIntoLightTwo.className} hidden text-sm text-gray-500 sm:block`}>
                      {invoice.email}
                    </p>
                  </div>
                </div>
                <p
                  className={`${shadowsIntoLightTwo.className} truncate text-sm font-medium md:text-base`}
                >
                  {invoice.amount}
                </p>
              </div>
        ...
        <div className="flex items-center pb-2 pt-6">
          ...
          <h3 className={`${shadowsIntoLightTwo.className} ml-2 text-sm text-gray-500`}>Updated just now</h3>
        </div>
      </div>
    </div>
  );
